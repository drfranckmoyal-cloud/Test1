...
Le jeu est né d'un défi « 100 pompes par jour pendant 30 jours », qui existe
toujours comme app séparée dans `../defi-100-pompes/`. Le défi lui-même est
devenu ici le programme *Saitama*.
